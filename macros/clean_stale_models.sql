...
{#  
    ...
    5. Command: dbt run-operation clean_stale_models --args '{'dry_run':'False'}'

#}

{% macro clean_stale_models(database=target.database, schema=target.schema, days=31, dry_run=True) %}
